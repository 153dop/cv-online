...
const typed = new Typed('.typed', {
   strings: [
      ...
      `Aprés une carriére sur Mirage 2000D, je me suis diriger vers l'instruction, et le savoir faire n'étant rien sans le savoir être.
      ...
      .<br>
      De nature curieuse, j'aime apprendre et m'adpter pour relever de nouveaux challenges.`,
   ],
   typeSpeed: 20,
   backSpeed: 5,
});
